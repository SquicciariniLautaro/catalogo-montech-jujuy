...
{/* Firma de Lambda Soluciones + Botón de Login */}
        ...
        <div className="flex items-center gap-4">
            ...
            {/* Candadito para ir al Login */}
            {!esAdmin && (
            <a href="/admin" className="text-gray-200 hover:text-gray-400 transition" title="Acceso Administrativo">

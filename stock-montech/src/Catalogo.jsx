...
return (
    <div className="relative p-2 md:p-4 max-w-3xl mx-auto font-sans bg-white pb-6 min-h-screen flex flex-col">
    ...
    <img 
      ...
      {/* CONTENEDOR RESPONSIVE PARA EL SCROLL HORIZONTAL EN CELULARES */}
    <div className="overflow-x-auto shadow-sm border border-gray-300 rounded-lg flex-grow w-full">
        ...
        <tbody>
            ...
            <tr>
                <td colSpan="5" className="text-center p-6 text-gray-500">No hay celulares en stock.</td>
            </tr>
            )}
            ...
            return (
                ...
                >
                <td className="p-3 text-center font-bold text-blue-600 bg-blue-50 border-r border-blue-100">
                    {celu.cantidad}
                </td>
                ...
                <td className="p-3 border-r border-gray-200 text-center font-semibold text-gray-700">
                    {celu.bateria}%
                </td>
                <td className="p-3 border-r border-gray-200 text-right font-black text-gray-900 text-[14px] whitespace-nowrap">
                    $ {precioPesos.toLocaleString("es-AR")}
                </td>
                <td className="p-3 text-[11px] text-gray-600 font-medium uppercase leading-relaxed">
                    {celu.detalles}
                </td>
                </tr>
            )
